package com.haroon.SpringBoot.Swagger.controller;
...
import com.haroon.SpringBoot.Swagger.model.Customer;
...
public class CustomerController {
	...
	@ApiResponses(value= {
			@ApiResponse(code=200, message="Customer Detail Retrieved", response=Customer.class),
